...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($email)) {
        ...
        try {
            ...
            $check = $conn->prepare("SELECT id, username FROM admin_users WHERE email = ?");
            $check->execute([$email]);
            $user = $check->fetch();
...
<head>
    ...
    <title>Admin Forgot Password - <?php echo SITE_NAME; ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="user-type">🔐 Admin Account Recovery</div>
